...
use chainweb_mining_client::workers::stratum::{
    ClientWorker, JobId, JobManager, MiningJob, Nonce1, Nonce2, NonceSize, compose_nonce,
    split_nonce,
};
...
fn test_job_manager_workflow() {
    ...
    for chain_id in 0..5 {
        ...
        let nonce1 = Nonce1::new(NonceSize::new(4).unwrap(), 0x12345678 + chain_id as u64).unwrap();
...
fn test_client_worker_identification() {
    ...
    let test_cases = vec![
        ...
        (
            "user.with.multiple.dots",
            "user",
            Some("with.multiple.dots"),
        ),
    ];
            ...
            for i in 0..100 {
                ...
                let job = MiningJob::new(
                    ...
                    Nonce1::new(
                        ...
                        thread_id as u64 * 1000 + i as u64,
                    )
                    .unwrap(),
                    false,
                );
